...
Captide aggregates and processes **corporate disclosures from publicly listed companies across 30 global markets**, transforming them into formats optimized for AI applications. Built on this expansive dataset of global filings, Captide’s agentic retrieval-augmented generation (RAG) systems deliver auditable, high-accuracy outputs in response to natural language queries—unlocking reliable **AI-driven insights grounded exclusively in authorative sources**.
...
<Steps>
  ...
  <Step title="Monitor API usage">
    Use the [Captide API Dashboard](https://app.captide.co/api-dashboard) to monitor your API usage, costs, and performance at a glance.
  </Step>
</Steps>
